...
public class ScrollOfDebug extends Scroll {
    ...
    public void doRead() {
        ...
        GameScene.show(new WndTextInput("Enter Wish:", null, "", 100, false,
                "Wish", "Cancel") {
    ...
    @Override public String name() {
        return "The Real Amulet of Yendor";
    }
    @Override public String desc() {
        StringBuilder builder = new StringBuilder();
        builder.appendLine("An amulet that gives you great power, letting you create virtually any item or mob in the game.")
                .appendLine("\nSupported Commands:");
